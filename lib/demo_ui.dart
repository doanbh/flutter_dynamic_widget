...
class DemoUIPage extends StatefulWidget {
  final String? path;
  const DemoUIPage(this.path, {Key? key}) : super(key: key);

  @override
  State<DemoUIPage> createState() => _DemoUIPageState();
}

class _DemoUIPageState extends State<DemoUIPage> {
  String? jsonString;
  ...
  Future<String?> _read() async {
    ...
    try {
      ...
      final File file = File('${widget.path}/my_file.txt');
